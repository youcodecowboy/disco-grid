...
import { getDashboardPreset } from "@/lib/grid-v2/presets"
...
export default function V2DashboardPage() {
  ...
  const initialState = useMemo(() => getDashboardPreset(), [])
  ...
  const {
    ...
    handleDrop,
    handleResizeStart,
  } = useGrid(initialState, "v2-dashboard")
  ...
  const actionButtons = useMemo(
    () => (
      <Button variant="outline" size="sm" onClick={toggleMode}>
        {state.mode === "edit" ? "Save Layout" : "Edit Layout"}
      </Button>
    ),
  ...
  return (
    <DataProviderProvider>
      <LayoutScaffold pageTitle="Dashboard" pageSubtext="Grid v2" actions={actionButtons}>
